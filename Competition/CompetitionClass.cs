...
namespace Competition.Runtime
{
        ...
        where TRight : Competitor, ICompetitor
    {
        ...
        public string TextResult { get; private set; } = null;
        ...
        private void Action(Competitor Character)
        {
            ...
            {
                TextResult += ($"{((ICompetitor)Character).GetName()}跳过攻击前阶段\n");
            }
            ...
            {
                TextResult += ($"{((ICompetitor)Character).GetName()}跳过攻击后阶段\n");
            }
        ...
        public void TaskFunction()
        {
            ...
            while (true)
            {
                ...
                if (Another(CurrnetCharacter).Health == 0)
                {
                    ...
                    TextResult += ($"{((ICompetitor)CurrnetCharacter).GetName()}胜利，剩下{CurrnetCharacter.Health}点生命\n");
                    break;
                }
