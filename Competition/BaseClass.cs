...
using Competition.CustomException;
    ...
    class Competitor
    {
        ...
        public string EffectedByRitaRossweisse_Clear(Competitor User)
        {
            try
            {
                ...
                Health += 3;
                return ($"{((ICompetitor)User).GetName()}发动技能女仆的温柔清理，降低{((ICompetitor)this).GetName()}{PreviousAttack - Attack}点攻击力\n");
            }
        ...
        public string EffectedByRitaRossweisse_Mind(Competitor User)
        {
            try
            {
                ...
                HasBeenCharmed = true;
                return ($"{((ICompetitor)User).GetName()}对{((ICompetitor)this).GetName()}使用魅惑技能，使其进入魅惑状态两回合（期间不能使用技能），永久降低60%伤害\n");
            }
            catch (UserMismatchingException)
            {
                return null;
        ...
        public string EffectedByFuHua(Competitor User)
        {
            try
            {
                ...
                if (ProbabilityFunction(User.HitRate))
                {
                    ...
                    return ($"{((ICompetitor)User).GetName()}发动技能形之笔墨，对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害，降低{PreviousHitRate - HitRate}%命中率\n");

                }
                else
                {
                    return ($"{((ICompetitor)User).GetName()}发动技能形之笔墨未命中\n");
                }
            }
            catch (UserMismatchingException)
            {
        ...
        public string EffectedByTheresaApocalypse_Judas(Competitor User)
        {
            try
            {
                ...
                if (ProbabilityFunction(30))
                {
                    ...
                    return ($"{((ICompetitor)User).GetName()}发动技能血犹大第一可爱，降低{((ICompetitor)this).GetName()}{PreviousDefense - Defense}点防御\n");
                }
                else
                {
                    return null;
        ...
        public string EffectedByTheresaApocalypse_Kick(Competitor User)
        {
            try
            {
                ...
                return ($"{((ICompetitor)User).GetName()}发动技能在线踢人，对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n");
            }
            catch (UserMismatchingException)
            {
                return null;
        ...
        public string EffectedByKiana_Spear(Competitor User)
        {
            try
            {
                ...
                if (ProbabilityFunction(User.HitRate))
                {
                    ...
                    return ($"{((ICompetitor)User).GetName()}发动技能吃我一矛！，对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n")
                    + ($"{((ICompetitor)this).GetName()}剩下{Health}点体力\n");
                }
                else
                {
                    return ($"{((ICompetitor)User).GetName()}发动技能吃我一矛！，未命中\n");
                }
            }
            catch (UserMismatchingException)
            {
        ...
        public string EffectedByKiana_Voice()
        {
            try
            {
                ...
                {
                    IsVertigo = true;
                    return ($"{((ICompetitor)this).GetName()}发动技能音浪~太强~，使自己眩晕一回合\n");
                }
                else
                {
                    return null;
        ...
        public string EffectedByRaidenMei_Singer(Competitor User)
        {
            try
            {
                ...
                {
                    IsParalysis = true;
                    return ($"{((ICompetitor)User).GetName()}发动技能崩坏世界的歌姬，使{((ICompetitor)this).GetName()}麻痹一回合\n");
                }
                else
                {
                    return null;
        ...
        public string EffectedByRaidenMei_Dragon(Competitor User)
        {
            try
            {
                ...
                return ($"{((ICompetitor)User).GetName()}发动技能雷电家的龙女仆，对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n")
                + ($"{((ICompetitor)this).GetName()}剩下{Health}点体力\n");
            }
            catch (UserMismatchingException)
            {
        ...
        public string EffectedByCorvusCorax_ToDefender(Competitor Defender)
        {
            try
            {
                ...
                {
                    AttackPercentage += 25;
                   return ($"{((ICompetitor)this).GetName()}发动技能不是针对你，提升自己对琪亚娜25%伤害\n");
                }
                else
                {
                    ...
                    {
                        AttackPercentage += 25;
                        return ($"{((ICompetitor)this).GetName()}发动技能不是针对你，提升自己25%伤害\n");
                    }
                    else
                    {
                        return null;
        ...
        public string EffectedByCorvusCorax_Island(Competitor User)
        {
            try
            {
                ...
                return ($"{((ICompetitor)User).GetName()}发动技能别墅小岛对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n")
                + ($"{((ICompetitor)this).GetName()}剩下{Health}点体力\n");
            }
            catch (UserMismatchingException)
            {
        ...
        public string EffectedByBronya_Cyberangel(Competitor User)
        {
            try
            {
                ...
                if (ProbabilityFunction(25))
                {
                    ...
                    return ($"{((ICompetitor)User).GetName()}发动技能天使重构，对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n")
                    + ($"{((ICompetitor)this).GetName()}剩下{Health}点体力\n");
                }
                else
                {
        ...
        public string EffectedByBronya_Mortar(Competitor User)
        {
            try
            {
                ...
                if (ProbabilityFunction(User.HitRate))
                {
                    ...
                    return ($"{((ICompetitor)User).GetName()}发动技能摩托拜客哒！，对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n");
                }
                else
                {
                    return ($"{((ICompetitor)User).GetName()}发动技能摩托拜客哒！未命中\n");
                }
            }
            catch (UserMismatchingException)
            {
        ...
        public string EffectedBySakura()
        {
            try
            {
                ...
                if (ProbabilityFunction(30))
                {
                    ...
                    return ($"{((ICompetitor)this).GetName()}发动技能八重樱的饭团，回复自己{Health - PreviousHealth}点血量\n");
                }
                else
                {
                    return null;
        ...
        public string EffectedByKallen(Competitor User)
        {
            try
            {
                ...
                if (ProbabilityFunction(User.HitRate))
                {
                    ...
                    return ($"{((ICompetitor)User).GetName()}发动技能卡莲的饭团，对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n");
                }
                else
                {
                    return ($"{((ICompetitor)User).GetName()}发动技能卡莲的饭团，未命中\n");
                }
            }
            catch (UserMismatchingException)
            {
        ...
        public string EffectedBySeeleVollerei()
        {
            try
            {
                ...
                if (((SeeleVollerei)this).Color == SeeleVollerei.SeeleVollereiColor.Black)
                {
                    ...
                    Defense += 5;
                    return ($"{((ICompetitor)this).GetName()}发动技能我换我自己，“去吧，希儿，去守护我们的约定”，降低{PreviousAttack - Attack}点攻击，提升{Health - PreviousHealth}点生命，提升{Defense - PreviousDefense}点防御\n");
                }
                //白变黑
                else if (((SeeleVollerei)this).Color == SeeleVollerei.SeeleVollereiColor.White)
                {
                    ...
                    return ($"{((ICompetitor)this).GetName()}发动技能我换我自己，“拜托了，另一个我”，提升{Attack - PreviousAttack}点攻击，降低{PreviousDefense - Defense}点防御\n");
                }
                else
                {
                    return null;
        ...
        public string EffectedByHimeko_Love(Competitor Defender)
        {
            try
            {
                ...
                if (((ICompetitor)Defender).GetName() == "KallenAndSakura")
                {
                    ...
                    return ($"{((ICompetitor)this).GetName()}发动技能真爱不死，提升100%伤害\n");
                }
                else
                {
                    return null;
        ...
        public string EffectedByHimeko_Alcohol()
        {
            try
            {
                ...
                return ($"{((ICompetitor)this).GetName()}发动技能干杯，朋友 提升{Attack - PreviousAttack}点攻击力，降低{PreviousHitRate - HitRate}%命中率\n");
            }
            catch (UserMismatchingException)
            {
                return null;
        ...
        public string GetAttacked(Competitor Attacker)
        {
            ...
            if (ProbabilityFunction(Attacker.HitRate))
            {
                ...
                if (Attacker.IsPhysical == true)
                {
                    ...
                    if (AttackValue < 0)
                    {
                        Result += ($"{((ICompetitor)Attacker).GetName()}普通攻击未对{((ICompetitor)this).GetName()}造成伤害\n");
                    }
                    else
                    {
                        if (Health >= AttackValue)
                        ...
                        Result += ($"{((ICompetitor)Attacker).GetName()}普通攻击对{((ICompetitor)this).GetName()}造成{PreviousHealth - Health}点伤害\n");
                    }
                }
                //元素攻击
                else
                ...
                Result += ($"{((ICompetitor)this).GetName()}剩下{Health}点生命值\n");
                return Result;
            }
            //普通攻击未命中
            else
            {
                return ($"{((ICompetitor)Attacker).GetName()}普通攻击未命中\n");
            }
        }
        //测试用方法，输出人物实时数据
        sealed public override string ToString()
        {
            ...
            Result.Append($"Name:{((ICompetitor)this).GetName()}\n");
